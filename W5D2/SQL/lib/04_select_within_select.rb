...
def sparse_continents
  # Find every country that belongs to a continent where each country's ==> continents with no countries about 25,000,000
  ...
  #===> all countries(names) WITH a country over 'X' (in table form) #<=== most deeply nested query
  #===> pull contients that EXIST in this table #<==== second most deeply nested
  #===> REMOVE these continents from a table that contains ALL continents #<==== top level
