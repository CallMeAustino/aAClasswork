  ...
  _createClass(Board, [{
    ...
    value: function render() {
      ...
      return this.props.board.grid.map(function (row, idx) {
        ...
        var line = row.map(function (tile, idx2) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_tile__WEBPACK_IMPORTED_MODULE_1__["default"], {
            key: "pos".concat(idx, "-").concat(idx2),
            tile: tile,
            updateGame: _this.props.update
          });
        });
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, line);
      });
    }
  }, {
    key: "rowCreate",
    value: function rowCreate() {}
  }]);

  return Board;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component); //We're going to return a component tree, starting with a top-level <div>. 
...
var Game = /*#__PURE__*/function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.state = {
      board: new _minesweeper__WEBPACK_IMPORTED_MODULE_1__["Board"](10, 1)
    };
...
var Tile = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Tile, [{
    ...
    key: "handleAuxClick",
    value: function handleAuxClick() {
      return console.log('Hello!');
    }
  }]);

  return Tile;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component); // onClick = {() => this.setState({ selected: breed }
